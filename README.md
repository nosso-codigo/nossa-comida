...
This application was generated using JHipster 7.1.0 and JHipster Quarkus 2.0.0-beta.1, you can find documentation and help at [https://www.jhipster.tech/documentation-archive/v7.1.0](https://www.jhipster.tech/documentation-archive/v7.1.0).
...
To build the final jar and optimize the nossaComida application for production, run:
