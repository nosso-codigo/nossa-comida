...
import br.com.nosso.codigo.comida.domain.User;
import br.com.nosso.codigo.comida.service.InvalidPasswordException;
import br.com.nosso.codigo.comida.service.MailService;
import br.com.nosso.codigo.comida.service.UserService;
import br.com.nosso.codigo.comida.service.UsernameAlreadyUsedException;
import br.com.nosso.codigo.comida.service.dto.PasswordChangeDTO;
import br.com.nosso.codigo.comida.service.dto.UserDTO;
import br.com.nosso.codigo.comida.web.rest.errors.EmailAlreadyUsedException;
import br.com.nosso.codigo.comida.web.rest.errors.EmailNotFoundException;
import br.com.nosso.codigo.comida.web.rest.errors.InvalidPasswordWebException;
import br.com.nosso.codigo.comida.web.rest.errors.LoginAlreadyUsedException;
import br.com.nosso.codigo.comida.web.rest.vm.KeyAndPasswordVM;
import br.com.nosso.codigo.comida.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (br.com.nosso.codigo.comida.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
